...
namespace iabi.BCF.Test.BCFTestCases.CreateAndExport
{
    ...
    public class MaximumInformationTest
    {
        ...
        public void Viewpoint_01_InMarkupSet()
        {
            ...
            var ViewpointElement = MarkupXml.DescendantNodes().OfType<XElement>().FirstOrDefault(Curr => Curr.Name.LocalName == "Viewpoints" && Curr.Attribute("Guid").Value == BCFTestCaseData.MaximumInformation_ViewpointGuid_01);
            ...
            Assert.AreEqual("Viewpoint_" + BCFTestCaseData.MaximumInformation_ViewpointGuid_01 + ".bcfv", ViewpointReferenceElement.DescendantNodes().OfType<XText>().First().Value);

            var SnapshotReferenceElement = ViewpointElement.Nodes().OfType<XElement>().FirstOrDefault(Curr => Curr.Name.LocalName == "Snapshot");
            Assert.AreEqual("Snapshot_" + BCFTestCaseData.MaximumInformation_ViewpointGuid_01 + ".png", SnapshotReferenceElement.DescendantNodes().OfType<XText>().First().Value);
        }
        ...
        public void Viewpoint_02_InMarkupSet()
        {
            ...
            var ViewpointElement = MarkupXml.DescendantNodes().OfType<XElement>().FirstOrDefault(Curr => Curr.Name.LocalName == "Viewpoints" && Curr.Attribute("Guid").Value == BCFTestCaseData.MaximumInformation_ViewpointGuid_02);
            ...
            var ViewpointReferenceElement = ViewpointElement.Nodes().OfType<XElement>().FirstOrDefault(Curr => Curr.Name.LocalName == "Viewpoint");
            Assert.AreEqual("Viewpoint_" + BCFTestCaseData.MaximumInformation_ViewpointGuid_02 + ".bcfv", ViewpointReferenceElement.DescendantNodes().OfType<XText>().First().Value);

            var SnapshotReferenceElement = ViewpointElement.Nodes().OfType<XElement>().FirstOrDefault(Curr => Curr.Name.LocalName == "Snapshot");
            Assert.AreEqual("Snapshot_" + BCFTestCaseData.MaximumInformation_ViewpointGuid_02 + ".png", SnapshotReferenceElement.DescendantNodes().OfType<XText>().First().Value);
        }
        ...
        public void Viewpoint_03_InMarkupSet()
        {
            ...
            var ViewpointElement = MarkupXml.DescendantNodes().OfType<XElement>().FirstOrDefault(Curr => Curr.Name.LocalName == "Viewpoints" && Curr.Attribute("Guid").Value == BCFTestCaseData.MaximumInformation_ViewpointGuid_03);
            ...
            var ViewpointReferenceElement = ViewpointElement.Nodes().OfType<XElement>().FirstOrDefault(Curr => Curr.Name.LocalName == "Viewpoint");
            Assert.AreEqual("Viewpoint_" + BCFTestCaseData.MaximumInformation_ViewpointGuid_03 + ".bcfv", ViewpointReferenceElement.DescendantNodes().OfType<XText>().First().Value);

            var SnapshotReferenceElement = ViewpointElement.Nodes().OfType<XElement>().FirstOrDefault(Curr => Curr.Name.LocalName == "Snapshot");
            Assert.AreEqual("Snapshot_" + BCFTestCaseData.MaximumInformation_ViewpointGuid_03 + ".png", SnapshotReferenceElement.DescendantNodes().OfType<XText>().First().Value);
        }
