...
namespace iabi.BCF.Tests.BCFTestCases.CreateAndExport
{
    ...
    public class MaximumInformationTest
    {
        ...
        public void Viewpoint_01_InMarkupSet()
        {
            ...
            Assert.Equal("Viewpoint_" + BCFTestCaseData.MaximumInformation_ViewpointGuid_01 + ".bcfv", ViewpointReferenceElement.DescendantNodes().OfType<XText>().First().Value);

            var SnapshotReferenceElement = ViewpointElement.Nodes().OfType<XElement>().FirstOrDefault(Curr => Curr.Name.LocalName == "Snapshot");
            Assert.Equal("Snapshot_" + BCFTestCaseData.MaximumInformation_ViewpointGuid_01 + ".png", SnapshotReferenceElement.DescendantNodes().OfType<XText>().First().Value);
        }
        ...
        public void Viewpoint_02_InMarkupSet()
        {
            ...
            var ViewpointReferenceElement = ViewpointElement.Nodes().OfType<XElement>().FirstOrDefault(Curr => Curr.Name.LocalName == "Viewpoint");
            Assert.Equal("Viewpoint_" + BCFTestCaseData.MaximumInformation_ViewpointGuid_02 + ".bcfv", ViewpointReferenceElement.DescendantNodes().OfType<XText>().First().Value);

            var SnapshotReferenceElement = ViewpointElement.Nodes().OfType<XElement>().FirstOrDefault(Curr => Curr.Name.LocalName == "Snapshot");
            Assert.Equal("Snapshot_" + BCFTestCaseData.MaximumInformation_ViewpointGuid_02 + ".png", SnapshotReferenceElement.DescendantNodes().OfType<XText>().First().Value);
        }
        ...
        public void Viewpoint_03_InMarkupSet()
        {
            ...
            var ViewpointReferenceElement = ViewpointElement.Nodes().OfType<XElement>().FirstOrDefault(Curr => Curr.Name.LocalName == "Viewpoint");
            Assert.Equal("Viewpoint_" + BCFTestCaseData.MaximumInformation_ViewpointGuid_03 + ".bcfv", ViewpointReferenceElement.DescendantNodes().OfType<XText>().First().Value);

            var SnapshotReferenceElement = ViewpointElement.Nodes().OfType<XElement>().FirstOrDefault(Curr => Curr.Name.LocalName == "Snapshot");
            Assert.Equal("Snapshot_" + BCFTestCaseData.MaximumInformation_ViewpointGuid_03 + ".png", SnapshotReferenceElement.DescendantNodes().OfType<XText>().First().Value);
        }
