...
namespace iabi.BCF.Tests.BCFTestCases.v21.CreateAndExport.Factory
{
    public static class MaximumInformationTestCase
    {
        ...
        public static VisualizationInfoComponents GetList_01()
        {
            ...
            {
                DefaultVisibilityComponents = bool.Parse(BCFTestCaseData.MaximimumInformation_Viewpoint_01_DefaultVisibilityComponents),
                DefaultVisibilityOpenings = bool.Parse(BCFTestCaseData.MaximimumInformation_Viewpoint_01_DefaultVisibilityOpenings),
                DefaultVisibilitySpaceBoundaries = bool.Parse(BCFTestCaseData.MaximimumInformation_Viewpoint_01_DefaultVisibilitySpaceBoundaries),
                DefaultVisibilitySpaces = bool.Parse(BCFTestCaseData.MaximimumInformation_Viewpoint_01_DefaultVisibilitySpaces),
