...
namespace Dangl.BCF.BCFv21.Schemas
{
    ...
    public partial class Topic
    {
        ...
        public List<string> ReferenceLink
        {
            get
            {
                if ((this._referenceLink == null))
                {
                    this._referenceLink = new List<string>();
                }
        ...
        public List<TopicDocumentReference> DocumentReference
        {
            get
            {
                if ((this._documentReference == null))
                {
                    this._documentReference = new List<TopicDocumentReference>();
                }
        ...
        public List<TopicRelatedTopic> RelatedTopic
        {
            get
            {
                if ((this._relatedTopic == null))
                {
                    this._relatedTopic = new List<TopicRelatedTopic>();
                }
    ...
    public partial class TopicDocumentReference
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof(TopicDocumentReference));
                }
                return serializer;
            }
        }
