...
namespace iabi.BCF.BCFv21.Schemas
{
    ...
    public partial class TopicDocumentReference
    {
        ...
        public static TopicDocumentReference Deserialize(string input)
        {
            ...
            {
                stringReader = new System.IO.StringReader(input);
                return ((TopicDocumentReference)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally
            {
                if ((stringReader != null))
    ...
    public partial class TopicRelatedTopic
    {
        ...
        public static TopicRelatedTopic Deserialize(string input)
        {
            ...
            {
                stringReader = new System.IO.StringReader(input);
                return ((TopicRelatedTopic)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally
            {
                if ((stringReader != null))
