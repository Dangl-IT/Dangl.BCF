...
using Point = Dangl.BCF.BCFv2.Schemas.Point;
...
namespace Dangl.BCF.Tests.BCFTestCases.v2.CreateAndExport.Factory
{
    public static class MaximumInformationTestCase
    {
        ...
        public static BCFTopic CreateTopic()
        {
            ...
            returnTopic.AddOrUpdateSnapshot(BcFv2TestCaseData.MAXIMUM_INFORMATION_VIEWPOINT_GUID_01, TestCaseResourceFactory.GetViewpointSnapshot(ViewpointSnapshots.MaximumInfo_Snapshot_01));
            returnTopic.AddOrUpdateSnapshot(BcFv2TestCaseData.MAXIMUM_INFORMATION_VIEWPOINT_GUID_02, TestCaseResourceFactory.GetViewpointSnapshot(ViewpointSnapshots.MaximumInfo_Snapshot_02));
            returnTopic.AddOrUpdateSnapshot(BcFv2TestCaseData.MAXIMUM_INFORMATION_VIEWPOINT_GUID_03, TestCaseResourceFactory.GetViewpointSnapshot(ViewpointSnapshots.MaximumInfo_Snapshot_03));
        ...
        public static IEnumerable<VisualizationInfo> CreateViewpoints()
        {
            ...
            yield return new VisualizationInfo
            {
                ...
                GUID = BcFv2TestCaseData.MAXIMUM_INFORMATION_VIEWPOINT_GUID_01,
            ...
            yield return new VisualizationInfo
            {
                ...
                GUID = BcFv2TestCaseData.MAXIMUM_INFORMATION_VIEWPOINT_GUID_02,
                //Lines = "",
                //OrthogonalCamera = "",
            ...
            yield return new VisualizationInfo
            {
                ...
                GUID = BcFv2TestCaseData.MAXIMUM_INFORMATION_VIEWPOINT_GUID_03,
                //Lines = "",
                //OrthogonalCamera = "",
        ...
        public static BCFTopic CreateSimpleTopicToActAsReference()
        {
            ...
            topic.Markup = new Markup
            {
                Topic = new Topic
                {
                    ...
                    Guid = BcFv2TestCaseData.MAXIMUM_INFORMATION_REFERENCED_TOPIC_GUID,
        ...
        private static Markup CreateMarkup()
        {
            ...
            markup.Topic = new Topic
            {
                ...
                Guid = BcFv2TestCaseData.MAXIMUM_INFORMATION_TOPIC_GUID,
                Index = "0",
