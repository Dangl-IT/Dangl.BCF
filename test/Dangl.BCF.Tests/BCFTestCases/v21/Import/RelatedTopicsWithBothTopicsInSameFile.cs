...
namespace Dangl.BCF.Tests.BCFTestCases.v21.Import
{
    public class RelatedTopicsWithBothTopicsInSameFile
    {
        ...
        public void WriteAndCompare()
        {
            ...
            ReadContainer.WriteStream(memStream);
            var data = memStream.ToArray();
            CompareTool.CompareFiles(TestCaseResourceFactory.GetImportTestCaseV21(BCFv21ImportTestCases.RelatedTopicsWithBothTopicsInSameFile), data);
        }
        ...
        public class Topic01
        {
            ...
            {
                Assert.Single(ReadTopic.Markup.Topic.RelatedTopic);
        ...
        public class Topic02
        {
            ...
            public void CheckCommentGuid_01()
            {
                var expected = "2125e721-7501-4468-a479-23498b97c67c";
                Assert.Contains(ReadTopic.Markup.Comment, curr => curr.Guid == expected);
            }
