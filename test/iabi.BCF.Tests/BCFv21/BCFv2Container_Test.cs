...
namespace iabi.BCF.Tests.BCFv21
{
    public class BcFv2ContainerTest
    {
        ...
        public class GetFilenameFromReference
        {
            ...
            {
                Assert.True(string.IsNullOrWhiteSpace(BCFv21Container.GetFilenameFromReference(null)));
            }
        ...
        public class TransformToRelativePath
        {
            ...
            {
                var created = BCFv21Container.TransformToRelativePath(null, null);
            ...
            {
                var created = BCFv21Container.TransformToRelativePath(string.Empty, null);
                Assert.True(string.IsNullOrWhiteSpace(created));
            }
            ...
            {
                var created = BCFv21Container.TransformToRelativePath(null, string.Empty);
                Assert.True(string.IsNullOrWhiteSpace(created));
            }
        ...
        public class GetAbsolutePath
        {
            ...
            public void EmptyOnEmptyInput_01()
            {
                var created = BCFv21Container.GetAbsolutePath(null, null);
                Assert.True(string.IsNullOrWhiteSpace(created));
            }
            ...
            public void EmptyOnEmptyInput_02()
            {
                var created = BCFv21Container.GetAbsolutePath(null, string.Empty);
                Assert.True(string.IsNullOrWhiteSpace(created));
            }
            ...
            {
                var created = BCFv21Container.GetAbsolutePath("SomePath", null);
        ...
        public class WriteStream
        {
            ...
            public Markup MockTopicMarkup()
            {
                ...
                returnObject.Topic.DocumentReference = new List<TopicDocumentReference>();
                returnObject.Topic.DocumentReference.Add(new TopicDocumentReference());
                returnObject.Topic.DocumentReference[0].Description = "This is what a referenced document's description would look like.";
                returnObject.Topic.DocumentReference[0].Guid = "E181000F-959B-46E4-A37A-7C57704DAA2D";
                returnObject.Topic.DocumentReference[0].isExternal = true;
                returnObject.Topic.DocumentReference[0].ReferencedDocument = "https://bim--it-net/Expect404.pdf";
                ...
                returnObject.Topic.ReferenceLink = new List<string> {"http://www.iabi.eu"};
