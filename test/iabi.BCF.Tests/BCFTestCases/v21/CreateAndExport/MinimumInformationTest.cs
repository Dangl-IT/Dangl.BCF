...
namespace iabi.BCF.Tests.BCFTestCases.v21.CreateAndExport
{
    public class MinimumInformationTest
    {
        ...
        public void CheckIfFilesPresent()
        {
            ...
            {
                BcFv21TestCaseData.MINIMUM_INFORMATION_TOPIC_GUID + "/markup.bcf",
                "bcf.version"
            };
        ...
        {
            var markupXml = XmlUtilities.GetElementFromZipFile(CreatedArchive, BcFv21TestCaseData.MINIMUM_INFORMATION_TOPIC_GUID + "/markup.bcf");
        ...
        {
            var topicXml = XmlUtilities.GetElementFromZipFile(CreatedArchive, BcFv21TestCaseData.MINIMUM_INFORMATION_TOPIC_GUID + "/markup.bcf").FirstNode as XElement;
