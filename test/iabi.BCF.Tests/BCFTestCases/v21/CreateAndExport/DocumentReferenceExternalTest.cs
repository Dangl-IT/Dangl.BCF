...
namespace iabi.BCF.Tests.BCFTestCases.v21.CreateAndExport
{
    ...
    public class DocumentReferenceExternalTest
    {
        ...
        public DocumentReferenceExternalTest()
        {
            ...
            {
                CreatedArchive = ZipArchiveFactory.ReturnAndWriteIfRequired(CreatedContainer, BCFv21TestCaseData.DocumentReferenceExternal_TestCaseName, TestCaseResourceFactory.GetReadmeForV21(BcfTestCaseV21.DocumentReferenceExternal));
            }
        }
