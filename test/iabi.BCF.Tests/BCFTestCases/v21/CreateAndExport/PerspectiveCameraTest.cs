...
namespace iabi.BCF.Tests.BCFTestCases.v21.CreateAndExport
{
    ...
    public class PerspectiveCameraTest
    {
        ...
        public PerspectiveCameraTest()
        {
            ...
            {
                CreatedArchive = ZipArchiveFactory.ReturnAndWriteIfRequired(CreatedContainer, BCFv21TestCaseData.PerspectiveCamera_TestCaseName, TestCaseResourceFactory.GetReadmeForV21(BcfTestCaseV21.PerspectiveCamera));
            }
        }
