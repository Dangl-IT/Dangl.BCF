...
namespace iabi.BCF.Tests.BCFTestCases.v21.CreateAndExport
{
    public class ExternalBIMSnippetTest
    {
        ...
        public ExternalBIMSnippetTest()
        {
            ...
            {
                CreatedArchive = ZipArchiveFactory.ReturnAndWriteIfRequired(CreatedContainer, BCFv21TestCaseData.ExternalBIMSnippet_TestCaseName, TestCaseResourceFactory.GetReadmeForV21(BcfTestCaseV21.ExternalBIMSnippet));
            }
        }
        ...
        public string[] ExpectedFiles
        {
            get
            {
                ...
                {
                    "bcf.version",
                    BCFv21TestCaseData.ExternalBIMSnippet_TopicGuid + "/markup.bcf"
                };
            }
        }
        ...
        {
            var MarkupXml = XmlUtilities.GetElementFromZipFile(CreatedArchive, BCFv21TestCaseData.ExternalBIMSnippet_TopicGuid + "/markup.bcf");
