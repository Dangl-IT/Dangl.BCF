...
namespace iabi.BCF.Tests.BCFTestCases.v21.CreateAndExport
{
    public class ExtensionSchemaTest
    {
        ...
        public ExtensionSchemaTest()
        {
            ...
            {
                CreatedArchive = ZipArchiveFactory.ReturnAndWriteIfRequired(CreatedContainer, BCFv21TestCaseData.ExtensionSchema_TestCaseName, TestCaseResourceFactory.GetReadmeForV21(BcfTestCaseV21.ExtensionSchema));
            }
        }
        ...
        public void CheckIfFilesPresent()
        {
            ...
            {
                BCFv21TestCaseData.ExtensionSchema_TopicGuid + "/markup.bcf",
                "project.bcfp",
                "extensions.xsd",
                "bcf.version"
            };
