...
namespace iabi.BCF.Tests.BCFTestCases.v2.CreateAndExport
{
    public class PdfFileTest
    {
        ...
        public string[] ExpectedFiles
        {
            get
            {
                return new[]
                {
                    ...
                    BcFv2TestCaseData.PDF_FILE_TOPIC_GUID + "/markup.bcf"
                };
            }
        }
        ...
        {
            var markupXml = XmlUtilities.GetElementFromZipFile(CreatedArchive, BcFv2TestCaseData.PDF_FILE_TOPIC_GUID + "/markup.bcf");
