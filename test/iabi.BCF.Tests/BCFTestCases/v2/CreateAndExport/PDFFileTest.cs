...
namespace iabi.BCF.Tests.BCFTestCases.v2.CreateAndExport
{
    public class PDFFileTest
    {
        ...
        public PDFFileTest()
        {
            ...
            {
                CreatedArchive = ZipArchiveFactory.ReturnAndWriteIfRequired(CreatedContainer, BCFv2TestCaseData.PDFFile_TestCaseName, TestCaseResourceFactory.GetReadmeForV2(BcfTestCaseV2.PDFFile));
            }
        }
        ...
        public string[] ExpectedFiles
        {
            get
            {
                return new[]
                {
                    ...
                    BCFv2TestCaseData.PDFFile_TopicGuid + "/markup.bcf"
                };
            }
        }
        ...
        {
            var MarkupXml = XmlUtilities.GetElementFromZipFile(CreatedArchive, BCFv2TestCaseData.PDFFile_TopicGuid + "/markup.bcf");
