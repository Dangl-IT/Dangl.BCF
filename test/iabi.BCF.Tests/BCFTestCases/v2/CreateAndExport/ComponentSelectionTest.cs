...
namespace iabi.BCF.Tests.BCFTestCases.v2.CreateAndExport
{
    ...
    {
        public BCFv2Container CreatedContainer;
        ...
        public ComponentSelectionTest()
        {
            ...
            {
                CreatedArchive = ZipArchiveFactory.ReturnAndWriteIfRequired(CreatedContainer, BcFv2TestCaseData.COMPONENT_SELECTION_TEST_CASE_NAME, TestCaseResourceFactory.GetReadmeForV2(BcfTestCaseV2.ComponentSelection));
            }
        }
