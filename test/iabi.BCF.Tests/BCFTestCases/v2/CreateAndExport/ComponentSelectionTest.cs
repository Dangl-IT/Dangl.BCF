...
namespace iabi.BCF.Tests.BCFTestCases.v2.CreateAndExport
{
    ...
    public class ComponentSelectionTest
    {
        ...
        public ComponentSelectionTest()
        {
            ...
            {
                CreatedArchive = ZipArchiveFactory.ReturnAndWriteIfRequired(CreatedContainer, BCFv2TestCaseData.ComponentSelection_TestCaseName, TestCaseResourceFactory.GetReadmeForV2(BcfTestCaseV2.ComponentSelection));
            }
        }
