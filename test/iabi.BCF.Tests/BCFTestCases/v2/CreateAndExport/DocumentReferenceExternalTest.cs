...
namespace iabi.BCF.Tests.BCFTestCases.v2.CreateAndExport
{
    ...
    public class DocumentReferenceExternalTest
    {
        ...
        public DocumentReferenceExternalTest()
        {
            ...
            {
                CreatedArchive = ZipArchiveFactory.ReturnAndWriteIfRequired(CreatedContainer, BCFv2TestCaseData.DocumentReferenceExternal_TestCaseName, TestCaseResourceFactory.GetReadmeForV2(BcfTestCaseV2.DocumentReferenceExternal));
            }
        }
