...
namespace iabi.BCF.Tests.BCFTestCases.v2.CreateAndExport
{
    ...
    public class DocumentReferenceExternalTest
    {
        ...
        public DocumentReferenceExternalTest()
        {
            ...
            {
                CreatedArchive = ZipArchiveFactory.ReturnAndWriteIfRequired(CreatedContainer, BcFv2TestCaseData.DOCUMENT_REFERENCE_EXTERNAL_TEST_CASE_NAME, TestCaseResourceFactory.GetReadmeForV2(BcfTestCaseV2.DocumentReferenceExternal));
            }
        }
