...
namespace iabi.BCF.Tests.BCFTestCases.v2.CreateAndExport
{
    ...
    public class OrthogonalCameraTest
    {
        ...
        public OrthogonalCameraTest()
        {
            ...
            {
                CreatedArchive = ZipArchiveFactory.ReturnAndWriteIfRequired(CreatedContainer, BCFv2TestCaseData.OrthogonalCamera_TestCaseName, TestCaseResourceFactory.GetReadmeForV2(BcfTestCaseV2.OrthogonalCamera));
            }
        }
