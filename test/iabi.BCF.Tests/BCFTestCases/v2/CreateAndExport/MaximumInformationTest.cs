...
namespace iabi.BCF.Tests.BCFTestCases.v2.CreateAndExport
{
    ...
    public class MaximumInformationTest
    {
        ...
        public MaximumInformationTest()
        {
            ...
            {
                CreatedArchive = ZipArchiveFactory.ReturnAndWriteIfRequired(CreatedContainer, BCFv2TestCaseData.MaximumInformation_TestCaseName, TestCaseResourceFactory.GetReadmeForV2(BcfTestCaseV2.MaximumInformation));
            }
        }
        ...
        public string[] ExpectedFiles
        {
            get
            {
                return new[]
                {
                    ...
                    BCFv2TestCaseData.MaximumInformation_TopicGuid + "/markup.bcf",
                    BCFv2TestCaseData.MaximumInformation_TopicGuid + "/Viewpoint_" + BCFv2TestCaseData.MaximumInformation_ViewpointGuid_01 + ".bcfv",
                    BCFv2TestCaseData.MaximumInformation_TopicGuid + "/Viewpoint_" + BCFv2TestCaseData.MaximumInformation_ViewpointGuid_02 + ".bcfv",
                    BCFv2TestCaseData.MaximumInformation_TopicGuid + "/Viewpoint_" + BCFv2TestCaseData.MaximumInformation_ViewpointGuid_03 + ".bcfv",
                    BCFv2TestCaseData.MaximumInformation_TopicGuid + "/Snapshot_" + BCFv2TestCaseData.MaximumInformation_ViewpointGuid_01 + ".png",
                    BCFv2TestCaseData.MaximumInformation_TopicGuid + "/Snapshot_" + BCFv2TestCaseData.MaximumInformation_ViewpointGuid_02 + ".png",
                    BCFv2TestCaseData.MaximumInformation_TopicGuid + "/Snapshot_" + BCFv2TestCaseData.MaximumInformation_ViewpointGuid_03 + ".png",
                    BCFv2TestCaseData.MaximumInformation_TopicGuid + "/JsonElement.json", // Data element of the BIM Snippet
                    BCFv2TestCaseData.MaximumInformation_ReferencedTopicGuid + "/markup.bcf" // Referenced topic
                };
            }
        }
        ...
        public void CheckIfFileDataIsEqual_JsonElement()
        {
            ...
            {
                CreatedArchive.Entries.FirstOrDefault(Curr => Curr.FullName == BCFv2TestCaseData.MaximumInformation_TopicGuid + "/JsonElement.json").Open().CopyTo(MemStream);
        ...
        public void CheckIfFileDataIsEqual_Snapshot01()
        {
            ...
            using (var MemStream = new MemoryStream())
            {
                CreatedArchive.Entries.FirstOrDefault(Curr => Curr.FullName == BCFv2TestCaseData.MaximumInformation_TopicGuid + "/Snapshot_" + BCFv2TestCaseData.MaximumInformation_ViewpointGuid_01 + ".png").Open().CopyTo(MemStream);
                var DataActual = MemStream.ToArray();
                Assert.True(DataExpected.SequenceEqual(DataActual));
            }
        }
        ...
        public void CheckIfFileDataIsEqual_Snapshot02()
        {
            ...
            using (var MemStream = new MemoryStream())
            {
                CreatedArchive.Entries.FirstOrDefault(Curr => Curr.FullName == BCFv2TestCaseData.MaximumInformation_TopicGuid + "/Snapshot_" + BCFv2TestCaseData.MaximumInformation_ViewpointGuid_02 + ".png").Open().CopyTo(MemStream);
                var DataActual = MemStream.ToArray();
                Assert.True(DataExpected.SequenceEqual(DataActual));
            }
        }
        ...
        public void CheckIfFileDataIsEqual_Snapshot03()
        {
            ...
            using (var MemStream = new MemoryStream())
            {
                CreatedArchive.Entries.FirstOrDefault(Curr => Curr.FullName == BCFv2TestCaseData.MaximumInformation_TopicGuid + "/Snapshot_" + BCFv2TestCaseData.MaximumInformation_ViewpointGuid_03 + ".png").Open().CopyTo(MemStream);
                var DataActual = MemStream.ToArray();
                Assert.True(DataExpected.SequenceEqual(DataActual));
            }
        }
        ...
        {
            var MarkupXml = XmlUtilities.GetElementFromZipFile(CreatedArchive, BCFv2TestCaseData.MaximumInformation_TopicGuid + "/markup.bcf");

            var ViewpointElement = MarkupXml.DescendantNodes().OfType<XElement>().FirstOrDefault(Curr => Curr.Name.LocalName == "Viewpoints" && Curr.Attribute("Guid").Value == BCFv2TestCaseData.MaximumInformation_ViewpointGuid_01);
            ...
            Assert.Equal("Viewpoint_" + BCFv2TestCaseData.MaximumInformation_ViewpointGuid_01 + ".bcfv", ViewpointReferenceElement.DescendantNodes().OfType<XText>().First().Value);

            var SnapshotReferenceElement = ViewpointElement.Nodes().OfType<XElement>().FirstOrDefault(Curr => Curr.Name.LocalName == "Snapshot");
            Assert.Equal("Snapshot_" + BCFv2TestCaseData.MaximumInformation_ViewpointGuid_01 + ".png", SnapshotReferenceElement.DescendantNodes().OfType<XText>().First().Value);
        }
        ...
        public void Viewpoint_02_InMarkupSet()
        {
            ...
            var ViewpointElement = MarkupXml.DescendantNodes().OfType<XElement>().FirstOrDefault(Curr => Curr.Name.LocalName == "Viewpoints" && Curr.Attribute("Guid").Value == BCFv2TestCaseData.MaximumInformation_ViewpointGuid_02);
            ...
            var ViewpointReferenceElement = ViewpointElement.Nodes().OfType<XElement>().FirstOrDefault(Curr => Curr.Name.LocalName == "Viewpoint");
            Assert.Equal("Viewpoint_" + BCFv2TestCaseData.MaximumInformation_ViewpointGuid_02 + ".bcfv", ViewpointReferenceElement.DescendantNodes().OfType<XText>().First().Value);

            var SnapshotReferenceElement = ViewpointElement.Nodes().OfType<XElement>().FirstOrDefault(Curr => Curr.Name.LocalName == "Snapshot");
            Assert.Equal("Snapshot_" + BCFv2TestCaseData.MaximumInformation_ViewpointGuid_02 + ".png", SnapshotReferenceElement.DescendantNodes().OfType<XText>().First().Value);
        }
        ...
        public void Viewpoint_03_InMarkupSet()
        {
            ...
            var ViewpointElement = MarkupXml.DescendantNodes().OfType<XElement>().FirstOrDefault(Curr => Curr.Name.LocalName == "Viewpoints" && Curr.Attribute("Guid").Value == BCFv2TestCaseData.MaximumInformation_ViewpointGuid_03);
            ...
            var ViewpointReferenceElement = ViewpointElement.Nodes().OfType<XElement>().FirstOrDefault(Curr => Curr.Name.LocalName == "Viewpoint");
            Assert.Equal("Viewpoint_" + BCFv2TestCaseData.MaximumInformation_ViewpointGuid_03 + ".bcfv", ViewpointReferenceElement.DescendantNodes().OfType<XText>().First().Value);

            var SnapshotReferenceElement = ViewpointElement.Nodes().OfType<XElement>().FirstOrDefault(Curr => Curr.Name.LocalName == "Snapshot");
            Assert.Equal("Snapshot_" + BCFv2TestCaseData.MaximumInformation_ViewpointGuid_03 + ".png", SnapshotReferenceElement.DescendantNodes().OfType<XText>().First().Value);
        }

        [Fact]
        public void Viewpoint_01_NoOrthogonalCameraSet()
        {
            var ViewpointXml = XmlUtilities.GetElementFromZipFile(CreatedArchive, BCFv2TestCaseData.MaximumInformation_TopicGuid + "/Viewpoint_" + BCFv2TestCaseData.MaximumInformation_ViewpointGuid_01 + ".bcfv");
        ...
        {
            var ViewpointXml = XmlUtilities.GetElementFromZipFile(CreatedArchive, BCFv2TestCaseData.MaximumInformation_TopicGuid + "/Viewpoint_" + BCFv2TestCaseData.MaximumInformation_ViewpointGuid_02 + ".bcfv");
            Assert.False(ViewpointXml.DescendantNodes().OfType<XElement>().Any(Curr => Curr.Name.LocalName == "OrthogonalCamera"));
        }
        ...
        {
            var ViewpointXml = XmlUtilities.GetElementFromZipFile(CreatedArchive, BCFv2TestCaseData.MaximumInformation_TopicGuid + "/Viewpoint_" + BCFv2TestCaseData.MaximumInformation_ViewpointGuid_03 + ".bcfv");
            Assert.False(ViewpointXml.DescendantNodes().OfType<XElement>().Any(Curr => Curr.Name.LocalName == "OrthogonalCamera"));
        }
