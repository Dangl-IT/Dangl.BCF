...
namespace iabi.BCF.Tests.BCFTestCases.v2.CreateAndExport.Factory
{
    public static class MaximumInformationTestCase
    {
        ...
        public static BCFTopic CreateTopic()
        {
            ...
            ReturnTopic.AddOrUpdateSnapshot(BCFv2TestCaseData.MaximumInformation_ViewpointGuid_01, TestCaseResourceFactory.GetViewpointSnapshot(ViewpointSnapshots.MaximumInfo_Snapshot_01));
            ReturnTopic.AddOrUpdateSnapshot(BCFv2TestCaseData.MaximumInformation_ViewpointGuid_02, TestCaseResourceFactory.GetViewpointSnapshot(ViewpointSnapshots.MaximumInfo_Snapshot_02));
            ReturnTopic.AddOrUpdateSnapshot(BCFv2TestCaseData.MaximumInformation_ViewpointGuid_03, TestCaseResourceFactory.GetViewpointSnapshot(ViewpointSnapshots.MaximumInfo_Snapshot_03));
        ...
        public static IEnumerable<VisualizationInfo> CreateViewpoints()
        {
            ...
            yield return new VisualizationInfo
            {
                ...
                GUID = BCFv2TestCaseData.MaximumInformation_ViewpointGuid_01,
            ...
            yield return new VisualizationInfo
            {
                ...
                GUID = BCFv2TestCaseData.MaximumInformation_ViewpointGuid_02,
                //Lines = "",
                //OrthogonalCamera = "",
            ...
            yield return new VisualizationInfo
            {
                ...
                GUID = BCFv2TestCaseData.MaximumInformation_ViewpointGuid_03,
                //Lines = "",
                //OrthogonalCamera = "",
        ...
        public static BCFTopic CreateSimpleTopicToActAsReference()
        {
            ...
            Topic.Markup = new Markup
            {
                Topic = new Topic
                {
                    ...
                    Guid = BCFv2TestCaseData.MaximumInformation_ReferencedTopicGuid,
        ...
        private static Markup CreateMarkup()
        {
            ...
            Markup.Topic = new Topic
            {
                ...
                Guid = BCFv2TestCaseData.MaximumInformation_TopicGuid,
                Index = "0",
