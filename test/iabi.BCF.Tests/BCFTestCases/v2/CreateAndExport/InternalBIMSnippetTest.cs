...
namespace iabi.BCF.Tests.BCFTestCases.v2.CreateAndExport
{
    public class InternalBIMSnippetTest
    {
        ...
        public InternalBIMSnippetTest()
        {
            ...
            {
                CreatedArchive = ZipArchiveFactory.ReturnAndWriteIfRequired(CreatedContainer, BCFv2TestCaseData.InternalBIMSnippet_TestCaseName, TestCaseResourceFactory.GetReadmeForV2(BcfTestCaseV2.InternalBIMSnippet));
            }
        }
        ...
        public string[] ExpectedFiles
        {
            get
            {
                ...
                {
                    "bcf.version",
                    BCFv2TestCaseData.InternalBIMSnippet_TopicGuid + "/markup.bcf",
                    BCFv2TestCaseData.InternalBIMSnippet_TopicGuid + "/JsonElement.json" // Data element of the BIM Snippet
                };
            }
        }
        ...
        public void CheckIfFileDataIsEqual_JsonElement()
        {
            ...
            {
                CreatedArchive.Entries.FirstOrDefault(Curr => Curr.FullName == BCFv2TestCaseData.InternalBIMSnippet_TopicGuid + "/JsonElement.json").Open().CopyTo(MemStream);
        ...
        {
            var MarkupXml = XmlUtilities.GetElementFromZipFile(CreatedArchive, BCFv2TestCaseData.InternalBIMSnippet_TopicGuid + "/markup.bcf");
